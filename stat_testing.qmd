...
modelo_1 <- lm(
  log_pib ~ DCI_symbolic, data = df_Total
)

modelo_2 <- lm(
  log_pib ~ DCI_synthetic, data = df_Total
)

modelo_3 <- lm(
  log_pib ~ DCI_symbolic + DCI_synthetic, data = df_Total
)

modelo_4 <- lm(
  log_pib ~ DCI_symbolic + DCI_synthetic + DCI_symbolic * DCI_synthetic, data = df_Total
)
...
modelo_1 <- lm(
  Alex_Score ~ DCI_symbolic, data = df_total
)

modelo_2 <- lm(
  Alex_Score ~ DCI_synthetic, data = df_total
)

modelo_3 <- lm(
  Alex_Score ~ DCI_symbolic + DCI_synthetic, data = df_total
)

modelo_4 <- lm(
  Alex_Score ~ DCI_symbolic + DCI_synthetic + DCI_symbolic * DCI_synthetic, data = df_total
)
...
modelo_1 <- lm(
  Times_Score ~ DCI_awards, data = df_Total
)

modelo_2 <- lm(
  Times_Score ~ DCI_wipo, data = df_Total
)

modelo_3 <- lm(
  Times_Score ~ DCI_awards + DCI_wipo, data = df_Total
)

modelo_4 <- lm(
  Times_Score ~ DCI_awards + DCI_wipo + DCI_awards * DCI_wipo, data = df_Total
)
...
modelo_1 <- lm(
  Alex_Score ~ DCI_awards, data = df_Total
)

modelo_2 <- lm(
  Alex_Score ~ DCI_wipo, data = df_Total
)

modelo_3 <- lm(
  Alex_Score ~ DCI_awards + DCI_wipo, data = df_Total
)

modelo_4 <- lm(
  Alex_Score ~ DCI_awards + DCI_wipo + DCI_awards * DCI_wipo, data = df_Total
)
...
modelo_1 <- lm(
  log_f25 ~ DCI_awards, data = df_total
)

modelo_2 <- lm(
  log_f25 ~ DCI_wipo, data = df_total
)

modelo_3 <- lm(
  log_f25 ~ DCI_awards + DCI_wipo, data = df_total
)

modelo_4 <- lm(
  log_f25 ~ DCI_awards + DCI_wipo + DCI_awards * DCI_wipo, data = df_total
)
